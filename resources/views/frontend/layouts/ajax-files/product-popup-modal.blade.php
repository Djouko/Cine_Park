...
<div class="details_extra_item">
    <h5>selectionnez <span>(optional)</span></h5>
...
<ul class="details_button_area d-flex flex-wrap">
    ...
    <li><button type="button" class="common_btn bg-danger">Plus de places disponibles</button></li>
    @else
    <li><button type="submit" class="common_btn modal_cart_button">Reserver</button></li>
    @endif
</ul>
</div>
    ...
    $(document).ready(function(){
        ...
        $("#modal_add_to_cart_form").on('submit', function(e){
            ...
            $.ajax({
                ...
                complete: function(){
                    $('.modal_cart_button').html('Reserver');
