...
<nav class="navbar navbar-expand-lg main_menu">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset(config('settings.logo')) }}" alt="CinePark" class="img-fluid">
        </a>
...
<div class="fp__menu_cart_area">
    <div class="fp__menu_cart_boody">
        <div class="fp__menu_cart_header">
            <h5>Films choisis (<span class="cart_count" style="font-size: 16px">{{ count(Cart::content()) }}</span>)</h5>
        ...
        <ul class="cart_contents">
            ...
            <li>
                ...
                <div class="menu_cart_text">
                    ...
                    <p class="size">Places: {{ $cartProduct->qty }}</p>
        ...
        <p class="subtotal">Total <span class="cart_subtotal">{{ currencyPosition(cartTotal()) }}</span></p>
        <a class="cart_view" href="{{ route('cart.index') }}"> Voir les details</a>
