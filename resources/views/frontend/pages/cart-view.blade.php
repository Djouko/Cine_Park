            ...
            <div class="row">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th class="fp__pro_icon">
                                            <a class="clear_all" href="{{ route('cart.destroy') }}">Supprimer tout</a>
                                        </th>
                                    </tr>
                                    ...
                                    @if (Cart::content()->count() === 0)
                                        <tr>
                                            <td colspan="6" class="text-center fp__pro_name"
                                                style="width: 100%;display: inline;">Le choix des films est vide!</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                    <div class="fp__cart_list_footer_button">
                        <h6>total Films</h6>
                        <p>total: <span id="subtotal">{{ currencyPosition(cartTotal()) }}</span></p>
                        <p>Autres frais: <span>$00.00</span></p>
                        <p>Reduction: <span id="discount">
                       ...
                       <div class="coupon_card">
                        ...
                        <div class="card mt-2">
                            <div class="m-3">
                                <span><b class="v_coupon_code">Appliquer le Couppon: {{ session()->get('coupon')['code'] }}</b></span>
                                <span>
                        ...
                        <a class="common_btn" href="{{ route('checkout.index') }}">Payer</a>
                    </div>
                </div>
            </div>
        </div>
