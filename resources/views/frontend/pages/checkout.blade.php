                ...
                <div class="col-lg-8 col-lg-7 wow fadeInUp" data-wow-duration="1s">
                    <div class="fp__checkout_form">
                        <div class="fp__check_form">
                            <h5>selectionner une information complementaire <a href="#" data-bs-toggle="modal" data-bs-target="#address_modal"><i
                                        class="far fa-plus"></i> ajouter une information complementaire</a></h5>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="address_modalLabel">Ajouter une nouvelle information complementaire
                                                </h1>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div  style="display:flex;">
                                                                <button style="width: 200px" type="button"
                                                                    class="common_btn cancel_new_address mr-2">Retour</button>
                                                                <button style="width: 200px" type="submit" class="common_btn">Sauvegarder l'information</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
