            ...
            <div class="container">
                <div class="fp__breadcrumb_text">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:;">Film Details</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-duration="1s">
                    <div class="fp__menu_details_text">
                        ...
                        <form action="" id="v_add_to_cart_form">
                            ...
                            @if ($product->productOptions()->exists())
                                <div class="details_extra_item">
                                    <h5>selectionnez <span>(optionel)</span></h5>
                        ...
                        <ul class="details_button_area d-flex flex-wrap">
                            ...
                            <li><a class="common_btn bg-danger" href="javascript:;">Plus de places disponibles</a></li>
                            @else
                            <li><a class="common_btn v_submit_button" href="#">Reserver</a></li>
                            @endif
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-contact" aria-selected="false">Commentaires</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                ...
                                <div class="fp__review_area">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <h4>{{ count($reviews) }} Commentaires</h4>
                                            <div class="fp__comment pt-0 mt_20">
                                                ...
                                                @endif
                                                @if (count($reviews) === 0)
                                                    <div class="alert alert-warning mt-4">Aucun commentaire trouvé!</div>
                                                @endif
                                        ...
                                        @else
                                        <div class="col-lg-4">
                                            <h4>Ecrire un commantaire</h4>
                                            <div class="alert alert-warning mt-4">Pardon connectez-vous pour ajouter un commentaire.</div>
                                        </div>
                                        @endauth
                                    </div>
                                </div>
