                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    <p id="menu-item-url-wrap">
                                                                        ...
                                                                        <select class="form-control" id="custom-menu-item-pages">
                                                                            ...
                                                                            <option value="Home" data-url="/">Accueil</option>
                                                                            <option value="Products" data-url="/products">Films</option>
                                                                            <option value="About" data-url="/about">A propos</option>
                                                                            <option value="Blogs" data-url="/blogs">Blogs</option>
                                                                            <option value="Contact" data-url="/contact">Contact</option>
                                                                            <option value="Chefs" data-url="/chef">Experts</option>
                                                                            <option value="Testimonials" data-url="/testimonials">Feedbacks</option>
                                                                            <option value="Privacy Policy" data-url="/privacy-policy">Politique de confidentialité</option>
                                                                            <option value="Trams and Conditions" data-url="/trams-and-conditions">Terms et conditions</option>
